...
%   updating.                                                                   %
%                                                                               %
%     Adaptive Algorithm used here: Godard                                      %
%                                                                               %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%   Definitions:
ensemble      = 10;                          % number of realizations within the ensemble
...
N             = 82;                            % number of coefficients of the adaptive filter
...
for l=1:ensemble,
    ...
    [y,e,W(:,:,l)]  =   Godard(x(1+delay:end),S);
