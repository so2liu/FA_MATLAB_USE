...
switch (waveformID)
    ...
    case 6  % CW signal with different phases
        for i = 1:4
            wfms{1,i} = real(iqtone('sampleRate', fs, 'tone', 50e6, 'phase', 45*pi/180*i));
        end
...
if (waveformID == 8)
    ...
    iqseq('define', seq1, 'arbConfig', awg1, 'keepOpen', 1, 'run', 0);
    iqseq('define', seq2, 'arbConfig', awg2, 'keepOpen', 1, 'run', 0);
...
iqseq('triggerMode', condTrig, 'arbConfig', awg1, 'keepopen', 1);
