...
% Last Modified by GUIDE v2.5 13-Jun-2015 06:25:54
...
if (~isempty(strfind(cfg.model, 'M8195A_2ch')))
    errordlg('This utility is not supported with M8195A in 2-channel mode');
end
