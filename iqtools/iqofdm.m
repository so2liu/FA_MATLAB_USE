function [iqdatapack datapack]= iqofdm(varargin)
...
for a=1:NumPackages 
  ...
  for i=1:NumSymbols
   ...
   if (correction)
      iqdata = iqcorrection(iqdata,OFDMSystemFrequency*oversampling);
   end
   ...
   iqdatapack=cat(2,iqdatapack,iqdata);
   datapack=cat(2,datapack,data);
