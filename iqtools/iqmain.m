...
% Last Modified by GUIDE v2.5 26-Apr-2016 14:28:11
...
set(handles.bottomText, 'String', '2016_06_23');
...
if (~isempty(arbConfig))
    if (~isempty(strfind(arbConfig.model, 'M8190')))
        set(handles.pushbuttonM8190ADemos, 'String', regexprep(get(handles.pushbuttonM8190ADemos, 'String'), 'M819.', 'M8190'));
    ...
    elseif (~isempty(strfind(arbConfig.model, 'M8195')))
        set(handles.pushbuttonM8190ADemos, 'String', regexprep(get(handles.pushbuttonM8190ADemos, 'String'), 'M819.', 'M8195'));
        set(handles.pushbuttonM8190ADemos, 'Enable', 'on');
    ...
    elseif (~isempty(strfind(arbConfig.model, 'M8196')))
        set(handles.pushbuttonM8190ADemos, 'String', regexprep(get(handles.pushbuttonM8190ADemos, 'String'), 'M819.', 'M8196'));
        set(handles.pushbuttonM8190ADemos, 'Enable', 'on');
        set(handles.uipanelM8190A, 'Visible', 'off');
        set(handles.uipanelM8195A, 'Visible', 'off');
...
if (isfield(handles, 'AWGSpecificFunctions') && handles.AWGSpecificFunctions && ~isempty(arbConfig) && ...
        (~isempty(strfind(arbConfig.model, 'M8190')) || ~isempty(strfind(arbConfig.model, 'M8195')) || ~isempty(strfind(arbConfig.model, 'M8196'))))
    pos(3) = 472;
...
% --- Executes on button press in pushbutton3phase.
function pushbutton3phase_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton3phase (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
loadArbConfig();    % make sure arbConfig exists
dphy();
...
% --- Executes on button press in pushbuttonCPHY_M8195A.
function pushbuttonCPHY_M8195A_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonCPHY_M8195A (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
loadArbConfig();    % make sure arbConfig exists
dphy();
...
% --- Executes on button press in pushbuttonENOB_M8196A.
function pushbuttonENOB_M8196A_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonENOB_M8196A (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
iqenob();

% --- Executes on button press in pushbuttonENOB_M8195A.
function pushbuttonENOB_M8195A_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonENOB_M8195A (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
iqenob();


% --- Executes on button press in pushbuttonENOB_M8190A.
function pushbuttonENOB_M8190A_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonENOB_M8190A (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
iqenob();
...
% --- Executes on button press in pushbuttonMultiPulseM8195A.
function pushbuttonMultiPulseM8195A_Callback(hObject, eventdata, handles)
% hObject    handle to pushbuttonMultiPulseM8195A (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
loadArbConfig();
multi_pulse();
